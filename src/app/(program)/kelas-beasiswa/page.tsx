    ...
    <section className="">
      <div className="my-14 relative mx-auto container">
        ...
        <p className="my-3">
          ...
          pendidikan bahasa Jepang di Kokusai Kotoba Gakuin Nihonggo gakko di Jepang.Bea siswa hanya mencover biaya pendidikan selama belajar/kuliah di Jepang dalam kurun waktu 2 sd 4 tahun selama di Jepang.
        </p>
        ...
        <p>Kelas Orientasi ini diselenggarakan 2 kali dalam 1 minggu (2 jam/pertemuan) dgn total masa belajar 1.5 bulan (14 kali pertemuan, sekitar 28 jam). </p>
        <br />
        <div>
